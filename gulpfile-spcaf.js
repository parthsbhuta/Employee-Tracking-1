...
function spcaf(cb) {
  ...
  var logQueue = [];
  var progress = 0;
  var app = spawn('C:\\Program Files (x86)\\Rencore\\SPCAF\\spcaf.exe', ['-i', __dirname, '-r', 'HTML', '-o', __dirname + '\\report.xml', '-v', 'detailed', '-s', __dirname + '\\SharePointFramework.spruleset']);
